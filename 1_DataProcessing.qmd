...
## a. Download fastQ files from ENA
...
# DESCRIPTION: Download via ftp the raw fastQ from ENA. The metadata is stored in the downloaded csv. 
# DATE: 10/06/2024

seq_ids=("SLX_17937" "SLX-18123")
...
for seq_number in "${seq_ids[@]}"; do
    ...
    DOWNLOAD_DIR="./${seq_number}_SLX_17937/${seq_number}_adult_P70"
    ...
    { 
        ...
        do
            ...
            # Download bam_uri
            curl -L -o "${DOWNLOAD_DIR}/${name}_$(basename "$bam_uri")" "$bam_uri"
...
## b. Quality control and alignment
