---
title: "3 - Visualization of intersected genes with Venn diagrams in esophagus HCA dataset"
format:
  html:
    toc: true
jupyter:
...
## 1. Detected in SComatic vs. intOGen
```{r}
...
## 2. Detected in SComatic vs. common cancer
...
## 3. Detected in SComatic vs intogen vs common cancer
